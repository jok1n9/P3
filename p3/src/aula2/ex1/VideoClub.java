...
public class VideoClub {
	...
	public void displayClientHistory() {
		...
		this.clients.get(getClientIndex(partner)).showHistory();
	}
	...
	public void removeStudent() {
		...
		if(getClientIndex(num) == -1) {
			System.out.print("This student is not in the list.\n");
		}
		else {
	...
	public void removeWorker() {
		...
		if(getClientIndex(num) == -1) {
			System.out.print("This worker is not in the list.\n");
		}
		else {
			this.clients.remove(getClientIndex(num));
			System.out.print("Worker Removed.\n");
		}
	}	
