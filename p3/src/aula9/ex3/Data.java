...
public class Data {
	...
	public Data(String data) {
		int d = Integer.valueOf(data.split("/")[0]);
		int m = Integer.valueOf(data.split("/")[1]);
		int y = Integer.valueOf(data.split("/")[2]);
	...
	public static Data today() {
		...
		return new Data(ld.getYear(),ld.getMonthValue(),ld.getDayOfMonth());
	}
